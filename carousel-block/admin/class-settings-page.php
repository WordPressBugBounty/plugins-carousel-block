...
class Settings_Page {
    ...
    public static function initialize_settings() {
        ...
        self::add_settings_field( 'hide_legacy_carousel', \__( 'Hide Old Carousel Blocks', 'cb' ), $options );
    ...
    public static function sanitize( $input ) {
        $sanitized_input = [];
        if ( isset( $input['hide_legacy_carousel'] ) ) {
            $sanitized_input['hide_legacy_carousel'] = \filter_var( $input['hide_legacy_carousel'], \FILTER_VALIDATE_BOOLEAN );
        }
        if ( isset( $input['hide_legacy_notice'] ) ) {
            $sanitized_input['hide_legacy_notice'] = filter_var( $input['hide_legacy_notice'], FILTER_VALIDATE_BOOLEAN );
        }
    ...
    public static function render_settings_field( $args ) {
        ...
        if ( $setting_id === 'hide_legacy_carousel' ) {
            echo __( 'Hide legacy (non-Swiper) Carousel Slider blocks from the editor inserter.', 'cb' );
        }
    ...
    public static function render_settings_page() {
        ...
        <div class="wrap cb-settings-page">
            <div class="notice notice-info">
                ...
                <p>You can optionally hide legacy blocks below.</p>
            </div>
